...
type: course
uid: 1bc369b7cf753e2ce0777b944523c88c
...
For guided practice and further exploration of how to debug, watch [Video Lecture 6: Debugging]({{< baseurl >}}/sections/library/videos/lecture-6-debugging).
...
For guided practice and further exploration of how to use MATLAB files, watch [Video Lecture 3: Using Files]({{< baseurl >}}/sections/library/videos/lecture-3-using-files).
